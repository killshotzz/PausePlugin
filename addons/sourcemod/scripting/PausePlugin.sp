    ...
    public void OnPluginStart() {
        ...
        if (!commands.GetKeyValue(i, command, function)) {
            LogError("Invalid command in commands.cfg.");
            continue;
        }
        RegConsoleCmd(command.c_str(), function.c_str(), ADMFLAG_GENERIC, "");
    }
